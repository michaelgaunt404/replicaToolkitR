#MG20251203 - I think this is very very old
#seems to me thjat this can be accomplished with the bounding box that is mapped over
#----- as in the seattle neighborhood project
